...
def sub_check_05(pose):
    if "LHip" in pose and "LKnee" in pose and "LAnkle" in pose:
        ...
        if cos >0.7 and knee[1] < hip[1]:
            return False
        elif knee[1] < hip[1]+0.08 and knee[1] > hip[1]-0.08:
            return True
...
def check_05(all_poses,pose):
    if "LHip" in pose and "LKnee" in pose and "LAnkle" in pose:
        ...
        elif knee[1] < hip[1]+0.08 and knee[1] > hip[1]-0.08 and len(all_poses)>3 and sub_check_05(all_poses[-1]) and sub_check_05(all_poses[-2]):
